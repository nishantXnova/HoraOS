# HoraOS — a lean, smooth, compatible Wear OS alternative

![android-ci](https://github.com/nishantXnova/HoraOS/actions/workflows/android-ci/badge.svg)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)

HoraOS is a minimal-Wear launcher and watch experience: a live watch face, quick
...
1. Clone: `git clone https://github.com/nishantXnova/HoraOS.git`
...
5. On the watch: swipe up → tap **HoraOS** → swipe left/right: settings | face | apps
...
Or `docker build -t horaos .` then `docker run --rm -v "%CD%:/horaos" horaos`
for the same build in a clean room. CI runs all three checks on every push/PR.

## Layout

```
WATCHOSS-aosp/launcher/   # HoraOS app (package com.horaos.launcher)
